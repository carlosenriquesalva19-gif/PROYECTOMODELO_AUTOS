...
1.  **Clona el repositorio:**
    ```bash
    git clone https://github.com/carlosenriquesalva19-gif/PROYECTOMODELO_AUTOS.git
    ```
...
4.  **Ejecuta la aplicación:** Selecciona un emulador o conecta un dispositivo físico y presiona el botón de **Run** .
